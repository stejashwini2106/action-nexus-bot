...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "BridgeOS turns messy human input into structured, verified next steps for high-stakes moments." },
      { name: "author", content: "BridgeOS" },
      { property: "og:title", content: "BridgeOS — Turn intent into safer action" },
      { property: "og:description", content: "A Gemini-powered bridge from messy human input to clear, verified action." },
